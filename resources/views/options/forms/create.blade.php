    ...
    <div class="divide-y divide-gray-200 dark:divide-gray-700">
        <div class="space-y-2 pt-6 pb-8 md:space-y-5">
            <h1
                ...
                Tworzenie opcji dla badania <span class="mr-3 font-medium uppercase text-cyan-500">"{!! $question->survey->name !!}"</span>
            </h1>
            <h3
            ...
            <div class="text-lg leading-7 text-gray-500 dark:text-gray-400">
                @include('options.forms.form', ['method' => 'POST', 'option' => null])
            </div>
        </div>
    </div>
@endsection
